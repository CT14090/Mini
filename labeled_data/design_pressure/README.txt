Azure Vision Training Data: Design Pressure

Add pressure tables, wind load charts, performance data with clear numerical values

AZURE OPENAI VISION GUIDELINES:
- Azure OpenAI will analyze these examples to understand your target content
- Focus on clear, well-defined visual elements that represent design pressure
