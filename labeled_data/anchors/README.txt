Azure Vision Training Data: Anchors

Add clear technical drawings of anchor details, fastener assemblies, connection methods

AZURE OPENAI VISION GUIDELINES:
- Azure OpenAI will analyze these examples to understand your target content
- Focus on clear, well-defined visual elements that represent anchors
