Azure Vision Training Data: Glazing

Add glazing cross-sections, glass specifications, IGU details with clear visual elements

AZURE OPENAI VISION GUIDELINES:
- Azure OpenAI will analyze these examples to understand your target content
- Focus on clear, well-defined visual elements that represent glazing
